...
class Frame1 extends JFrame implements ActionListener {
        ...
        Frame1() {
                ...
                lblsubmit = new JLabel("Developed By : Nandini");
                add(lblsubmit);
                ...
                try {
                        ...
                        if (ae.getActionCommand() == "Update") {
                                ...
                                stmt.executeUpdate("UPDATE pay1 SET name='" + txtname.getText() + "',department='"
                                                + txtdepartment.getText() + "',days='" + txtdays.getText() + "',rate='"
                                                + txtrate.getText() + "',salary='" + txtsalary.getText() + "' WHERE id="
                                                + txtid.getText() + "");
                        ...
                        if (ae.getActionCommand() == "Save") {
                                ...
                                stmt.executeUpdate("INSERT  INTO pay1 VALUES('" + txtid.getText() + "','"
                                                + txtname.getText() + "','" + txtdepartment.getText() + "','"
                        ...
                        if (ae.getActionCommand() == "Next") {
                                if (rs.next()) {
                                        ...
                                        JOptionPane.showMessageDialog(null, "You are At Already Last Record", "Message",
